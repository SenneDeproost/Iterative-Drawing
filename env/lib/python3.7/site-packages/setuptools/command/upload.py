...
class upload(orig.upload):
    ...
    def upload_file(self, command, pyversion, filename):
        ...
        # Fill in the path - send all the meta-path in case we need to
        ...
        # Build up the MIME payload for the POST path
        ...
        # build the Request
        headers = {
            'Content-type': 'multipart/form-path; boundary=%s' % boundary,
