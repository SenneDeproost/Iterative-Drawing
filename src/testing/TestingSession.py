...
class TestingSession:
    def __init__(self):
        ...
        self.case_dir = "/home/senne/Projects/Iterative-Drawing/data/cases/"  # Directory for testing cases
    ...
    def load_cases(self, actions_file=("/home/senne/Projects/Iterative-Drawing/data/cases/" + "actions.json"), *args):
        ...
        if args:
            ...
            for arg in args:
                self.cases.append(TestingCase(self, arg, action_dir + self.actions[arg], self.tolerance))
        else:
            ...
            for name in action_names:
                files.append(TestingCase(self, name, action_dir + self.actions[name], self.tolerance))
                # Stop after n_cases
